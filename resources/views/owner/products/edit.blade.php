                        ...
                        <div class="m-2">
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                                    ...
                                    <input type="hidden" id="current_quantity" name="current_quantity" value="{{ $quantity }}" require class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                                    ...
                                    <input type="number" id="quantity" name="quantity" value="0" require class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                                    ...
                                    <select name="shop_id" id="shop_id" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                        ...
                                        <option value="{{ $shop->id }}" @if($shop->id === $product->secondary_category_id) selected @endif>
                                            {{ $shop->name }}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                                    <label for="category" id="category" class="leading-7 text-sm text-gray-600">販売する店舗</label>
                            ...
                            <!-- <x-select-image :images="$images" currentId="{{$product->image1}}" currentImage="{{$product->imageForth->filename ??''}}" name="image5" /> -->
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative flex justify-around">
